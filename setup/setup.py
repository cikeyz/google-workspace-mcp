...
SCOPES = [
    ...
    # Forms API (added 2026-08-10 for the ExampleCo Google MCP: read responses
    # + create/edit forms). Requires re-auth if an existing token lacks them.
    "https://www.googleapis.com/auth/forms.body",
    "https://www.googleapis.com/auth/forms.responses.readonly",
    # Slides / Tasks / Chat / Meet (added 2026-08-11 for the ExampleCo Google
    # MCP extension: slides read+create, tasks management, chat spaces/messages,
    # meet space creation). Requires re-auth if an existing token lacks them.
...
# Override with GOOGLE_REDIRECT_URI for Web-type OAuth clients whose console
# allows a different URI (e.g. an n8n callback) instead of localhost.
